...
<%  
     String fname1="",filename1="",filename2="";
...
<%	  
	...
	{  
		...
		//filename= destFolder + filename; 
                 filename1=(String)session.getAttribute("email"); 
                 filename2=filename1+filename;
                filename= destFolder + filename2;
	...
	{  
       ...
       PreparedStatement pst=con.prepareStatement("update sm_user_info set picture=? where email=?");
        pst.setString(1,filename2);
        pst.setString(2,filename1);
        pst.executeUpdate();
        con.close(); 
